...
namespace SurfacePoker
{
    ...
    public partial class GlowVisualization : TagVisualization
    {
        ...
        public void setPlayername(String playername) {
            ...
            PlayernameVisu.Content = this.playername;
        }

        public void setTagInfo(String tagInfo) {
            this.tagInfo = tagInfo;
            TagInfo.Content = this.tagInfo;
        ...
        private void Playername_TouchDown(object sender, System.Windows.Input.TouchEventArgs e)
        {
